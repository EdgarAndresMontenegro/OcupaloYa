...
class State extends Model
{
	...
	public function __construct()
	{
		...
		$this->fillable = [ "country_id", "name", "created_at", "updated_at" ];
		// variable que contiene los campos que no queremos dejar ver
		$this->hidden = [ "" ];
	}

	// función para guardar un usuario
	public function all( $input = "name", $order = "asc" )
	{
	...
	public function find_country_id( $country_id )
	{
		return parent::customer(" SELECT * FROM ". $this->table ." WHERE country_id = '".$country_id."' ORDER BY name ASC ");
	}
