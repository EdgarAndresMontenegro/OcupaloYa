...
class Storage extends Model
{
	...
	public function __construct()
	{
		...
		$this->fillable = [ "immovable_id", "height", "max_volume", "entries_quantity", "average_temperature", "store_recomendation", "vehicle_entry_height", "garage", "created_at", "updated_at" ];
