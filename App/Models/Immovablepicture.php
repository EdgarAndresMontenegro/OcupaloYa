...
class Immovablepicture extends Model
{
	...
	public function __construct()
	{
		...
		$this->table = "immovable_picture";
		// llenamos la variable que contiene los datos que se pueden registrar en masa 
		$this->fillable = [ "immovable_id", "name", "created_at", "updated_at" ];
	...
	public function find_by_immovable_id( $immovable_id )
	{
		return parent::customer( " SELECT ". $this->selectInputs() ." FROM ". $this->table ." WHERE immovable_id = '".$immovable_id."' " );
	}
