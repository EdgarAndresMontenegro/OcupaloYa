...
class City extends Model
{
	...
	public function __construct()
	{
		...
		$this->fillable = [ "state_id", "name", "created_at", "updated_at" ];
	...
	public function find_state_id( $state_id )
	{
		return parent::customer(" SELECT * FROM ". $this->table ." WHERE state_id = '".$state_id."' ORDER BY name ASC ");
	}
