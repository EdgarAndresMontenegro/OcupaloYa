...
class Houseflat extends Model
{
	...
	public function __construct()
	{
		...
		$this->table = "house_flat";
		// llenamos la variable que contiene los datos que se pueden registrar en masa 
		$this->fillable = [ "immovable_id", "bedroom_quantity", "bathroom_quantity", "garage", "number_of_floors", "yard", "social_zone", "administration_price", "clothes_room", "elevator", "balcony", "created_at", "updated_at" ];
