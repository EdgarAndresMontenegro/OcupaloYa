...
class Plansection extends Model
{
	...
	public function __construct()
	{
		...
		$this->table = "plan_sections";
		// llenamos la variable que contiene los datos que se pueden registrar en masa 
		$this->fillable = [ "plan_id", "section_id",  "created_at", "updated_at" ];
	...
	public function find_by_plan_id( $plan_id )
	{
		return parent::customer( " SELECT ". $this->selectInputs() ." FROM ". $this->table ." WHERE plan_id = '".$plan_id."' " );
	}
	...
	// función para buscar un usuario por el name
	public function delete_by_plan_id( $plan_id )
	{
		return parent::customer( " DELETE FROM ". $this->table ." WHERE plan_id = '".$plan_id."' " );
	}
