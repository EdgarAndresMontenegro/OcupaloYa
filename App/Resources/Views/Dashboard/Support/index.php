	...
	<div class="container pt-5">
		...
		<div class="row align-items-center justify-content-center">
			...
			<div class="col-12 content-form-search">
				<div class="card">
					<div class="card-body">
						<form class="form-search" method="get" action="<?php echo RUTA_URL; ?>/Dashboard/Support/Pagination" data-url-change="<?php echo RUTA_URL; ?>/Dashboard/Support/Listing">
							<div class="row align-items-center">
								...
								<div class="col-md-2 text-lg-center">
									<a href="<?php echo RUTA_URL; ?>/Dashboard/Support/Create" class="btn btn-info waves-effect btn-block">
