...
<?php require_once RUTA_RESOURCES.'/Views/Dashboard/Support/tabs.php'; ?>
		...
		<div class="col-lg-8 mt-lg-0 mt-3">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-6 ">
							<h5 class="card-title m-0 text-truncate">Mal funcionamiento de la pagina</h5>
						</div>
						<div class="col-6 text-right">
							<p class="m-0"><span class="panel-cuadrado blue darken-1 text-white"><i class="fas fa-question-circle mr-1"></i>PQR</span></p>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-6 ">
							<button type="button" class="btn btn-primary waves-effect btn-sm">Responder</button>
						</div>
