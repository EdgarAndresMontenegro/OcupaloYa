...
<div class="container-fluid container-main" >
	<form class="form-edit" method="post" action="<?php echo RUTA_URL; ?>/Dashboard/Configurations/Role/Update">
							...
							<div class="row align-items-center my-4  mt-5">
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										<div class="col-12">
											<input type="hidden" id="id" name="id" value="<?php echo ucfirst($params['role']['id']); ?>" />
											<input type="text" id="rol" name="rol" class="browser-default form-control" placeholder="Tipo de rol. Ej: Administrador, Cliente, etc..." value="<?php echo ucfirst($params['role']['name']); ?>" />
										</div>
									</div>
								</div>
							</div>
