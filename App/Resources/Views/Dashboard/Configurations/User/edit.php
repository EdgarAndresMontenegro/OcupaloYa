...
<div class="container-fluid container-main">
	<form class="form-edit" method="post" action="<?php echo RUTA_URL; ?>/Dashboard/Configurations/User/Update">
							...
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">
										...
										<a class="btn btn-danger btn-sm float-right" href="<?php echo RUTA_URL; ?>/Dashboard/Configurations/User/Listing">
											Listado
										</a>
									</h5>
											...
											<div class="form-group">
												<select id="rol_id" name="rol_id" class="browser-default form-control">
													...
													<?php 
														...
														{
															$selected = "";
															if( $role['id'] == $params['user']['rol_id'] )
																$selected = "selected";
															echo "<option ".$selected." value='".$role['id']."'>".ucwords( $role['name'] )."</option>";
														} 
													?>
												</select>
											</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row align-items-center mt-4 mb-1">
										<div class="col-12">
											<div class="form-group">
												<input type="number" name="telephone" id="telephone" class="form-control" placeholder="300 000 0000" value="<?php echo $params['userdata']['telephone']; ?>">
											</div>
										</div>
									</div>
								</div>
	...
	<div class="modal-dialog mt-5" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-sm btn-success crop_button" data-action="<?php echo RUTA_URL; ?>/Dashboard/Configurations/User/uploadPhoto">Recortar</button>
			</div>
		</div>
	</div>
</div>
