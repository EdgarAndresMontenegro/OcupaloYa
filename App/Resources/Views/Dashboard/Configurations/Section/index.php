...
<div class="container-fluid container-main">
	<div class="container mt-5">
		...
		<div class="row align-items-center justify-content-center">
			...
			<!-- sección para la card de búsqueda -->
			<div class="col-12 content-form-search">
				<div class="card">
					<div class="card-body">
						<form class="form-search" method="get" action="<?php echo RUTA_URL; ?>/Dashboard/Configurations/Section/Pagination" data-url-change="<?php echo RUTA_URL; ?>/Dashboard/Configurations/Section/Listing">
							<div class="row align-items-center">
								...
								<div class="col-md-2 text-lg-center">
									<a href="<?php echo RUTA_URL; ?>/Dashboard/Configurations/Section/Create" class="btn btn-info waves-effect btn-block">
			...
			<!-- fin sección para la card de búsqueda -->
		...
		<!-- fin modal para eliminar un registro -->
