...
<div class="container-fluid container-main">
	<form class="form-create" method="post" action="<?php echo RUTA_URL; ?>/Dashboard/Ally/Store" autocomplete="off">
							...
							<div class="row align-items-center my-4  mt-5">
								...
								<div class="col-12">
									<div class="form-group">
										<input type="text" name="razon_social" id="razon_social" class="form-control validate_crop_image" placeholder="Razón social (*)" value="">
									</div>
								</div>
								...
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="text" name="nit" id="nit" class="form-control" placeholder="0000000000-0">
										</div>
									</div>
								</div>
								<div class="col-12"> <hr style="border-style: dashed; border-color: #ccc;"> </div>
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="date" name="fecha_de_fundacion" id="fecha_de_fundacion" class="form-control" placeholder="Fecha de fundacion" value="">
										</div>
									</div>
								</div>
								<div class="col-12"> <hr style="border-style: dashed; border-color: #ccc;"> </div>
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="url" name="sitio_web" id="sitio_web" class="form-control" placeholder="https://www.example.com" value="">
										</div>
									</div>
								</div>
								<div class="col-12"> <hr style="border-style: dashed; border-color: #ccc;"> </div>
						...
						<div class="card-body pt-0">
							<div class="row align-items-center">
								...
								<div class="col-12">
									...
									<div class="form-group">
										<input type="text" name="nombre_representante" id="nombre_representante" class="form-control" placeholder="Nombre del representante (*)" data-url="<?php echo RUTA_URL; ?>/Dashboard/Ally/Find-owner">
								...
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="number" name="telefono_representante" id="telefono_representante" class="form-control" placeholder="300 000 0000" value="">
										</div>
									</div>
								</div>
								<div class="col-12"> <hr style="border-style: dashed; border-color: #ccc;"> </div>
							...
							<div class="row align-items-center">
								...
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="text" id="direccion_sucursal" name="direccion_sucursal[]" class="browser-default form-control" placeholder="Dirección (*)" value="" />
										</div>
									</div>
								</div>
								<div class="col-12"> <hr style="border-style: dashed; border-color: #ccc;"> </div>
								...
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="text" id="telefono_sucursal" name="telefono_sucursal[]" class="browser-default form-control" placeholder="Teléfono" value="" />
										</div>
									</div>
								</div>
								<div class="col-12"> <hr style="border-style: dashed; border-color: #ccc;"> </div>
								<div class="col-12">
									<div class="row align-items-center justify-content-between">
										...
										<div class="col-7">
											<input type="text" id="celular_sucursal" name="celular_sucursal[]" class="browser-default form-control" placeholder="Celular" value="" />
										</div>
									</div>
								</div>
								<div class="col-12 col-md-6 d-none">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="lat-1" name="la[]t" placeholder="Latitude">
									</div>
								</div>
								<div class="col-12 col-md-6 d-none">
									<div class="form-group">
										<label for="lon-1">Longitude</label>
										<input type="text" class="form-control" id="lon-1" name="lon[]" placeholder="Longitude">
									</div>
								</div>
							</div>
						</div>
