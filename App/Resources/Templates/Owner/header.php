				...
				<div class="row">
					<div class="col-6 col-md-8">
						...
						<div class="header-navbar-primary">
							<ul class="list-unstyled">
								<li class="active">
									<a href="<?php echo RUTA_URL; ?>/Owner/">
								...
								<li>
									<a href="">Mis inmuebles</a>
								</li>
								<li>
									<a href="">Soporte</a>
								</li>
								<li>
									<a href="<?php echo RUTA_URL; ?>">Ir a la página</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="col-6 col-md-4 header-navbar-second">
						<div class="icon-header">
							<a href="<?php echo RUTA_URL; ?>/Owner/Immovable/Publish" data-toggle="tooltip" title="Publicar un anuncio">
						...
						<div class="icon-header">
							<a href="<?php echo RUTA_URL; ?>/" data-toggle="tooltip" title="Cartera">
						...
						<div class="icon-header icon-user">
							...
							<div class="card-options card-options-user scroll">
								<ul>
									<li>
										<a href="<?php echo RUTA_URL; ?>/Owner/User/Profile">
