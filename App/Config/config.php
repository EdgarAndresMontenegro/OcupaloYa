...
// ruta url del sitio
define( 'RUTA_URL', 'http://localhost/proyectos/ocupaloya');
...
// definimos la zona horaria del servidor
define('DB_DTZ','America/Bogota');
// tamaño max. de los archivos
define('MAX_SIZE', 1024*50000);
