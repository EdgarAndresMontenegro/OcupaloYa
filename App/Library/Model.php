...
class Model extends Conex
{
	...
	protected function customer( $sql )
	{
	...
	// $order: tipo de orden por el cual se desea visualizar
	protected function pagination( $pagina, $value_whr = null, $input_whr = 'id', $sql = 'NULL', $input_ord = 'id', $order = 'asc' )
	{
		// funcion para arreglar los campos que podemos dejar ver
		$this->selectInputs();
	...
	protected function render( $pagina, $value_whr, $cant )
	{
