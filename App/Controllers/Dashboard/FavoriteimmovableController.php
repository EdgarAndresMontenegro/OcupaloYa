...
class FavoriteimmovableController extends Controller
{
	...
	public function __construct()
	{
		...
		// instanciamos el modelo de favoriteimmovable
		$this->FavoriteimmovableModel = $this->model('Favoriteimmovable');
	}
	...
	public function store()
	{
		...
		$result = $this->FavoriteimmovableModel->store( $request );
		// Validamos si existe un error
		if( !$result )
		{
	...
	public function update()
	{
		...
		// Realizamos la petición de registro
		$result = $this->FavoriteimmovableModel->update( $request );
		// Validamos si existe un error
		if( !$result )
		{
			// Agregamos el mensaje a la variable para ser mostrada
	...
	public function delete()
	{
		...
		// Realizamos la petición de registro
		$result = $this->FavoriteimmovableModel->delete( $_POST['id'] );
		// Validamos si existe un error
		if( !$result )
		{
			// Agregamos el mensaje a la variable para ser mostrada
