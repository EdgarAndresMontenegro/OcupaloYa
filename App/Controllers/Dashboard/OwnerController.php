...
class OwnerController extends Controller
{
	...
	{	
		// mostramos la vista
		$this->redirect('Dashboard/Owner/listing');
	}
	...
	public function create()
	{
		...
		$params = [
			...
			'roles' => $this->roleModel->find( 4 ),
		];
		/* código para cargar la vista para almacenar un registro */
		echo $this->view( 'Dashboard/Owner/create', $params );
	}
	...
	public function edit( $slug )
	{
		...
		/* código para cargar la vista para almacenar un registro */
		echo $this->view( 'Dashboard/Owner/edit', $params );
	}
	...
	public function profile()
	{
		...
		echo $this->view( 'Dashboard/Owner/profile', $params );
	}
	...
	public function listing( $pagina = 1, $input_whr = "name", $value_whr = null )
	{
		...
		// mostramos la vista al usuario
		echo $this->view( 'Dashboard/Owner/index', $lista );
	}
	...
	public function data( $pagina, $input_whr, $value_whr )
	{
		...
		$data = $this->userModel->listing_owner( $pagina, $input_whr, $value_whr );
						...
						<div class="card">
							<div class="card-body">
								<div class="card-title">
									<a href="'.RUTA_URL.'/Dashboard/Owner/Edit/'.$user['slug'].'" class="float-right h6 text-primary mr-3 btn-outline-primary btn-sm">
