...
class UniversityshareController extends Controller
{
	...
	public function __construct()
	{
		...
		// instanciamos el modelo de universityshare
		$this->UniversityshareModel = $this->model('Universityshare');
	}
	...
	public function store()
	{
		...
		$result = $this->UniversityshareModel->store( $request );
		// Validamos si existe un error
		if( !$result )
		{
	...
	public function update()
	{
		...
		// Realizamos la petición de registro
		$result = $this->UniversityshareModel->update( $request );
		// Validamos si existe un error
		if( !$result )
		{
			// Agregamos el mensaje a la variable para ser mostrada
	...
	public function delete()
	{
		...
		// Realizamos la petición de registro
		$result = $this->UniversityshareModel->delete( $_POST['id'] );
		// Validamos si existe un error
		if( !$result )
		{
			// Agregamos el mensaje a la variable para ser mostrada
