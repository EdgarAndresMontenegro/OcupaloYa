...
class TicketController extends Controller
{
	...
	{	
		// mostramos la vista
		$this->redirect('Dashboard/Support/Ticket/listing');
	}
	...
	public function create()
	{
		...
		echo $this->view( 'Dashboard/Support/Ticket/create', $params );
	}
	...
	public function edit( $name )
	{
		...
		/* código para cargar la vista para almacenar un registro */
		echo $this->view( 'Dashboard/Support/Ticket/edit', $params );
	}
	...
	public function listing( $pagina = 1, $input_whr = "name", $value_whr = null )
	{
		...
		echo $this->view( 'Dashboard/Support/Ticket/index', $lista );
	}
							...
							<div class="card-body">
								<div class="card-title mb-0 row">
									...
									<div class="col-12 col-sm-6 col-md-5 col-lg-6">
										<a href="'.RUTA_URL.'/Dashboard/Support/Ticket/Edit/'.$plan['name'].'" class="h6 text-primary mr-3 btn-outline-primary btn-sm mr-2" title="Actualizar">
											<i class="fa fa-pen"></i>
										...
										<form id="form-delete-'.$plan['id'].'" action="'.RUTA_URL.'/Dashboard/Support/Ticket/Delete" method="POST" style="display: none;">
											'.$this->csrfToken().'
