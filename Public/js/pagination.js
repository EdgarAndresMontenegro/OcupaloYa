$(document).ready(function() {
	...
	$(".link_pagination").click(function(){
		...
		var form = $(this).parent("div").parent("div").parent("div").parent("div").siblings(".content-form-search").children(".card").children(".card-body").children("form");
		// obtenemos el action del formulario de para buscar y cargar los datos de la búsqueda
...
function pagination( url, url_change, pagina = 1, input_whr = 'id', value_whr = 'null' )
{
	$.ajax({
		...
		success: function( response ) {
			...
			$(".render-pagination").append( response.render + '<script>$(document).ready(function() {$(".link_pagination").click(function(){var form = $(this).parent("div").parent("div").parent("div").parent("div").siblings(".content-form-search").children(".card").children(".card-body").children("form");var url = form.attr("action");var url_change = form.data("url-change");var pagina = $(this).data("pagina");pagination( url, url_change, pagina, input_whr(), value_whr() );});});</script>' );
